...
struct Launchpad: Decodable {
    ...
    static let ccsfs = Launchpad(
        name: "CCSFS SLC 40", locality: "Cape Canaveral", region: "Florida",
    ...
    static let vafb = Launchpad(
        name: "VAFB SLC 4E", locality: "Vandenberg Special Force Base", region: "California",
    ...
    static let ksc = Launchpad(
        name: "KSC LC 39A", locality: "Cape Canaveral", region: "Florida",
    ...
    static let kwajaleinAtoll = Launchpad(
        name: "Kwajalein Atoll", locality: "Omelek Island", region: "Florida",
        latitude: 9.0477206, longitude: 167.7431292, launchAttempts: 5, launchSuccesses: 2,
        status: "retired", details: """
    ...
    static let unknown = Launchpad(name: "", locality: "", region: "", latitude: 0.0, longitude: 0.0,
                                   launchAttempts: 0, launchSuccesses: 0, status: "", details: "")
}
